...
{0x10010000, 0x10010014,0x00400000, 0x00400014, 0x0040001C}, ERR_OK, ERR_OK
        ...
        {{".data",
                               "data1: .word 0xf0, 100, -234, 4322",
                               "data2: .word 200, -100, 300, 432",
                               ".text",
                               "main: add $s0, $s1, $s2",
                               "subu $t0, $t2, $t3",
                               "or $at, $v0, $v1",
                              ...
                              "",
                              "label:"},
            {PACK_R(0x00, 17, 18, 16, 0, 0x20), PACK_R(0x00, 10, 11, 8, 0, 0x23), PACK_R(0x00, 2, 3, 1, 0, 0x25),
            PACK_R(0x00, 28, 29, 30, 0, 0x26), PACK_R(0x00, 17, 18, 16, 0, 0x27), PACK_R(0x00, 17, 18, 16, 0, 0x2B),
            PACK_R(0x00, 18, 17, 16, 0, 0x04), PACK_R(0x00, 10, 9, 8, 0, 0x06), PACK_R(0x00,29, 30, 28, 0, 0x07),
            PACK_R(0x00, 0, 17, 16, 31, 0x00), PACK_R(0x00, 0, 9, 8, 0, 0x03), PACK_I(0x08, 17, 16, 0xF7AA),
            PACK_I(0x09, 17, 16, 8349), PACK_I(0x0C, 17, 16, 12324), PACK_I(0x0E, 17, 16, 1424), PACK_I(0x0B, 17, 16, 0xF5CC),
            PACK_I(0x2B, 29, 16, 0xFFEC), PACK_J(0x03, 0x00100012)},
            {0xf0, 100, -234, 4322, 200, -100, 300, 432},
             0,
            {0x10010000, 0x10010010, 0x00400000, 0x00400048, 0x00400048}, ERR_OK, ERR_OK}
